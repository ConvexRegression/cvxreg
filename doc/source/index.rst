.. ConvexRegression documentation master file, created by
   sphinx-quickstart on Tue Jun  6 14:06:22 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to ConvexRegression
============================================

**Convex Regression for machine learning.**

ConvexRegression is an open source Python package implementing convex regression models for machine learning. It is built on top of the `pyStoNED <https://pypi.org/project/pystoned/>`_ package for Convex Nonparametric Least Square estimator. 
